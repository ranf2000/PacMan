...
class Character:
 ...
 #   def invalid(self):
  #      self.grid_pt_prev.not_affected()
...
class Pacman(Character):
 ...
 #       self.grid_pt_next.make_next()
    ...
    def eat_power_pellet(self): pass


    def fire_portal_gun(self, color): pass


    #      if not self.reallydead:
    #          self.dead = True
    ...
    def update(self):
        if self.at_dest():   self.draw(); self.eat_point(); return
        self.location_displayed = False
...
class Ghost(Character):
 ...
 #       self.grid_pt_next.make_next()
    ...
    def kill_pacman(self):
        collisions = pg.sprite.groupcollide(self.ghosts, self.pacman, True, False)
        if collisions:
            for pacman in collisions.values():
                pacman.dead = True
...
# class Power Pill
# ===================================================================================================
class Powerpill(Character):
    images_pman = [pg.image.load('images/pmanopen' + str(x) + '.png') for x in range(0, 12)]

    def __init__(self, game, v=Vector(-1, 0), grid_pt=None):
        super().__init__(game=game, v=v, name="Power Pill", scale=0.55, grid_pt=game.maze.location(0, 2),
                         grid_pt_next=game.maze.location(0, 2), scale_factor=3)
        self.image = pg.image.load('images/ship.bmp')
        self.origimage = self.image
        self.prev_angle = 90.0
        self.scale = 0.8
